...
namespace Perspektiva.Helpers
{
  public class GuessHelper
  {
    ...
    public void SaveGuess(UserGuess guess)
    {
      ...
      {
        string query = "INSERT INTO [UserGuess](PerspectiveID,UserID, Latitude,Longitude,TimeStamp,PerspectiveGuessPicture) VALUES(@PerspectiveID,@UserID, @Latitude,@Longitude,@TimeStamp,@PerspectiveGuessPicture)";
        ...
        using (SqlCommand cmd = new SqlCommand(query))
        {
          ...
          cmd.Parameters.AddWithValue("@PerspectiveID", guess.PerspectiveID);
          cmd.Parameters.AddWithValue("@PerspectiveGuessPicture", guess.PerspectiveGuessPictureByte);
